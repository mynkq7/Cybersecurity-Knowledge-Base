...
ping ping www.google.com result (ip address of site →142.250.193.36)

then filter in wireshark ip.addr == 142.250.193.36

tcp and ip.addr == 142.250.193.36 or udp and ip.addr == 142.250.193.36 capturing passsword